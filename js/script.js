...
if (menuLinks.length > 0) {
  ...
  function onMenuLinkClick(e) {
    ...
    if (
      ...
      const gotoBlockButton = gotoBlock.querySelector("h2");
      const heightWC = window.innerHeight / 2;
      const heightIC = gotoBlockButton.offsetHeight / 2;
      const gotoBlockValue =
      gotoBlockButton.getBoundingClientRect().top +
        pageYOffset -
        heightWC +
        heightIC;
...
document.querySelectorAll(".select").forEach(function (dropDownWrapper) {
  ...
  const dropDownItems = dropDownList.querySelectorAll(".select__item");
